...
import AdminNestedRoute from './AdminNestedRoute';
    ...
    render(){
        ...
        const drawer = (
            <div className={classes.drawerRoot}>
                ...
                <AdminDrawerMenu menu={adminMenu}/>
                <Divider/>
            </div>
        )
        return (
...
export default connect(mapStateToProps,{me})(withStyles(authStyle)(AdminDashboard));