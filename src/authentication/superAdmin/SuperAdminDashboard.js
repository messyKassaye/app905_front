...
import adminMenu from './data/superAdminMenu'
import SuperAdminDrawerMenu from './SuperAdminDrawerMenu';
import SuperAdminNestedRoute from './SuperAdminNestedRoute';
       ...
       const {container} = this.props;
        ...
        const drawer = (
            <div className={classes.drawerRoot}>
                ...
                <SuperAdminDrawerMenu menu={adminMenu}/>
                <Divider/>
            </div>
        )
        return (
...
export default connect(mapStateToProps,{me})(withStyles(authstyle)(SuperAdminDashboard))